...
class Submittor extends Thread {
  ...
  public void run() {
    ...
    for (String jobDesc : myJobDescs) {
    	...
    	int burstDescription;  // The description of that Job.  (For FCFS this will be a single integer token)
    	...
    	id = array[0];
    	delay = Integer.parseInt(array[1]);
    	burstDescription = Integer.parseInt(array[2]);
