...
class Job extends Thread {
  ...
  private final Condition myCondition; // This is associated with the OS's single reentrant lock
  							...
  							// When we introduce time-slicing, the Job can use this to suspend
   ...
   */
  public Job(int burstDescriptor, SystemSimulator s, String name, JobWorkable workToDo) {
    // Initialize stuff
    myOS = s;
    myCondition = s.getSingleThreadMutex().newCondition();
    
    burstTime =  burstDescriptor;
    work = workToDo;
